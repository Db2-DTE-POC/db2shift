...
IMPORT FROM customers.del OF DEL COMMITCOUNT 10000 INSERT INTO CUSTOMERS;
IMPORT FROM customers.js OF ASC METHOD l(1 2000) INSERT INTO CUSTOMERS_JSON(INFO);